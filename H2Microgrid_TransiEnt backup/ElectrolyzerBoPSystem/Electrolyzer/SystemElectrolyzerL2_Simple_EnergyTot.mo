...
//     redeclare model CostSpecsGeneral = CostSpecsElectrolyzer,
  ...
  PEMElectrolyzer_L2_EnergyTot electrolyzer(
...
//   end if;
  ...
  connect(electrolyzer.gasPortOut, massflowSensor_ely.gasPortIn) annotation (Line(
      ...
      color={255,255,0},
      thickness=1.5));
  connect(P_el_set, electrolyzer.P_el_set) annotation (Line(points={{0,108},{0,26},{-53.8,26},{-53.8,12}}, color={0,127,127}));
  connect(temperatureOutElectrolyzer, electrolyzer.temperatureOut) annotation (Line(points={{106,10},{8,10},{8,-8},{-36,-8},{-36,-14},{-64,-14},{-64,-3.2},{-55.6,-3.2}}, color={0,0,127}));
  connect(electrolyzer.fluidPortIn, fluidPortIn) annotation (Line(
      points={{-40,-9},{-40,-108},{44,-108},{44,-84},{60,-84},{60,-98}},
      color={175,0,0},
      thickness=0.5));
  connect(electrolyzer.fluidPortOut, fluidPortOut) annotation (Line(
      points={{-40,-4},{-34,-4},{-34,-18},{-60,-18},{-60,-98}},
      color={175,0,0},
      thickness=0.5));
