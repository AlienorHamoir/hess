...
//________________________________________________________________________________//
  ...
  Modelica.Blocks.Sources.Constant constM(k=1)    annotation (Placement(transformation(extent={{40,-66},{20,-46}})));
  ...
  FeedInStation_Storage feedInStation(
  usePowerPort=true,
    start_pressure=true,
    ...
    p_out=5000000,
    p_start=5000000,
    integrateMassFlow=false) annotation (Placement(transformation(extent={{-38,-64},{-18,-44}})));
equation
  connect(feedInStation.gasPortOut, boundaryRealGas_pTxi.gasPort) annotation (Line(
      points={{-28,-63.9},{-28,-72}},
      color={255,255,0},
      thickness=1.5));
  ...
  connect(constM.y, feedInStation.m_flow_feedIn) annotation (Line(points={{19,-56},{-12,-56},{-12,-46},{-18,-46}}, color={0,0,127}));
