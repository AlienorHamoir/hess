...
//________________________________________________________________________________//
  ...
  inner TransiEnt.SimCenter simCenter(redeclare TransiEnt.Basics.Media.Gases.VLE_VDIWA_NG7_H2_SRK_var
                                                                                            gasModel1)   annotation (Placement(transformation(extent={{-90,-100},{-70,-80}})));
  TransiEnt.Components.Gas.Compressor.CompressorRealGasIsentropicEff_L1_simple compressorRealGasIsentropicEff_L1_simple(
    ...
    redeclare model CostSpecsGeneral = TransiEnt.Components.Statistics.ConfigurationData.GeneralCostSpecs.IonicCompressor,
    m_flowInput=true,
    Cspec_demAndRev_el(displayUnit="EUR/MWh") = 2.7777777777778e-08) annotation (Placement(transformation(extent={{-10,60},{10,40}})));
  ...
  TransiEnt.Components.Gas.Compressor.CompressorRealGasIsothermal_L1_simple compressorRealGasIsothermal_L1_simple(
    ...
    redeclare model CostSpecsGeneral = TransiEnt.Components.Statistics.ConfigurationData.GeneralCostSpecs.IonicCompressor,
    m_flowInput=true,
    Cspec_demAndRev_el(displayUnit="EUR/MWh") = 2.7777777777778e-08) annotation (Placement(transformation(extent={{-10,-10},{10,10}})));

  inner TransiEnt.ModelStatistics modelStatistics annotation (Placement(transformation(extent={{-70,-100},{-50,-80}})));
  ...
  TransiEnt.Components.Gas.Compressor.CompressorRealGasIsothermal_L1_simple compressorRealGasIsothermal_L1_simple1(
    presetVariableType="dp",
    use_Delta_p_input=true,
    P_el_n(displayUnit="MW") = 10000000,
    redeclare model CostSpecsGeneral = TransiEnt.Components.Statistics.ConfigurationData.GeneralCostSpecs.IonicCompressor,
    m_flowInput=false,
    Cspec_demAndRev_el(displayUnit="EUR/MWh") = 2.7777777777778e-8) annotation (Placement(transformation(extent={{-12,-70},{8,-50}})));
  Modelica.Blocks.Sources.Ramp ramp1(
    duration=500,
    startTime=250,
    height=50e5,
    offset=100e5) annotation (Placement(transformation(extent={{94,-64},{74,-44}})));
  TransiEnt.Components.Gas.Compressor.Controller.ControllerCompressor_dp controllerCompressor_dp annotation (Placement(transformation(extent={{-18,-38},{2,-18}})));
  TransiEnt.Components.Sensors.RealGas.PressureSensor pressureSensor annotation (Placement(transformation(extent={{14,-60},{34,-40}})));
  TransiEnt.Components.Boundaries.Gas.BoundaryRealGas_Txim_flow source3(m_flow_const=1) annotation (Placement(transformation(extent={{-60,-70},{-40,-50}})));
  TransiEnt.Components.Electrical.Machines.MotorComplex motorComplex(eta=0.97) annotation (Placement(transformation(extent={{6,66},{26,86}})));
  TransiEnt.Components.Boundaries.Electrical.ComplexPower.SlackBoundary slackBoundary annotation (Placement(transformation(extent={{36,66},{56,86}})));
equation
