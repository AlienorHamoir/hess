...
model PEMElectrolyzer_L2_EnergyTot "PEMElectrolyzer_L2 Proton exchange membrane electrolyzer with selectable physics submodels"
...
end PEMElectrolyzer_L2_EnergyTot;
