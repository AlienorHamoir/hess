...
model PEMElectrolyzer_L2_compEnergy "PEMElectrolyzer_L2 Proton exchange membrane electrolyzer with selectable physics submodels"
...
equation
  ...
  P_el_tot = P_el + der(E_dry) + coolingPumpPowerIn + storageCompressorPowerIn;
...
end PEMElectrolyzer_L2_compEnergy;
