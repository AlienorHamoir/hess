...
model ElectrolyzerRecord
  ...
  PEMElectrolyzer_L2_EnergyTot_Inv_innerCooling electrolyzer1(
  ...
  CoolingSystem.HeatPortCooling.innerCooling_Modelica indirectCooling_Modelica annotation (Placement(transformation(
        extent={{-23,-11},{23,11}},
        rotation=180,
        origin={-41,-53})));
protected
