...
*/
  ...
  TransiEnt.Basics.Interfaces.Electrical.ElectricPowerIn storageCompressorPowerIn "Electrical power from the storage compressor" annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-120,-76})));
  Modelica.Blocks.Sources.RealExpression P_el_out(y=P_el_tot) annotation (Placement(transformation(extent={{-100,-80},{-80,-60}})));
  TransiEnt.Basics.Interfaces.Electrical.ElectricPowerOut electrolyzerPowerOut annotation (Placement(transformation(extent={{-66,-80},{-46,-60}})));
initial equation
...
equation
  ...
  connect(P_el_out.y, electrolyzerPowerOut) annotation (Line(points={{-79,-70},{-56,-70}}, color={0,0,127}));
