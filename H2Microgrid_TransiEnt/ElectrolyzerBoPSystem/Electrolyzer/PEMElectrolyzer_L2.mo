...
public
  ...
  parameter Real E_dry_spec=500 "specific energy consumption of dryer in Wh/kg H2";
...
public
 ...
 // replaceable TransiEnt.Producer.Gas.Electrolyzer.Base.Specifications.AREVAGiner46kW Specification
 //        constrainedby TransiEnt.Producer.Gas.Electrolyzer.Base.Specifications.BaseElectrolyzerL2Specification "Record containing technical data of electrolyzer system" annotation (
...
//     choices(choicesAllMatching=true);
  ...
  electrolyzerTemperature temperature(cooling_PID(activate_(y=true)))
...
*/
  ...
  Modelica.Blocks.Tables.CombiTable1Ds EfficiencyCurve_Inverter(
    ...
    tableOnFile=false,
    columns={2,2},
    table=[0.05,0.892;0.10,0.936;0.20,0.958;0.25,0.962;0.3,0.965;0.5,0.967;0.75,0.965;1,0.962])          annotation (Placement(transformation(extent={{-12,-6},{8,14}})));
