...
model PEMElectrolyzer_L2_EnergyTot_Inv_Cooling "PEMElectrolyzer_L2 Proton exchange membrane electrolyzer with selectable physics submodels"
...
public
  ...
  replaceable model Temperature1 = H2Microgrid_Transient.ElectrolyzerBoPSystem.Electrolyzer.Temperature1           constrainedby TransiEnt.Producer.Gas.Electrolyzer.Base.Physics.Temperature.PartialTemperature
...
*/
  ...
  Temperature1 temperature annotation (Placement(transformation(extent={{18,-16},{38,4}})));
initial equation
...
equation
  ...
  P_el_tot = P_el + der(E_dry);  // + P_el_pump ==| create error (after inverter) + P_compressor
...
end PEMElectrolyzer_L2_EnergyTot_Inv_Cooling;
