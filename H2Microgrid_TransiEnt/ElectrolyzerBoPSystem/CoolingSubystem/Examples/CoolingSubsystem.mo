within H2Microgrid_TransiEnt.ElectrolyzerBoPSystem.CoolingSubystem.Examples;
model CoolingSubsystem
 ...
 inner Modelica.Fluid.System system(energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  Modelica.Fluid.Machines.Pump pump annotation (Placement(transformation(extent={{-40,-96},{-20,-76}})));
  Buildings.Experimental.DHC.Loads.HotWater.BaseClasses.HeatExchangerPumpController conPum annotation (Placement(transformation(extent={{6,-90},{26,-70}})));
equation
