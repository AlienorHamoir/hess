within H2Microgrid_TransiEnt.ElectrolyzerBoPSystem.CoolingSubystem.HeatPortCooling;
model CoolingModel

  Buildings.Fluid.Movers.SpeedControlled_y pump(redeclare package Medium = Buildings.Media.Water, redeclare H2Microgrid_TransiEnt.ElectrolyzerBoPSystem.CoolingSubystem.HeatPortCooling.CoolingPumpDESL
                                                                                                                                                                                                      per)
