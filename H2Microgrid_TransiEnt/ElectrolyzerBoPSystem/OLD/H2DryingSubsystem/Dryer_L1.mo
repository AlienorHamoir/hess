within H2Microgrid_TransiEnt.ElectrolyzerBoPSystem.OLD.H2DryingSubsystem;
...
//________________________________________________________________________________//
  ...
  parameter TILMedia.VLEFluidTypes.BaseVLEFluid medium_gas=simCenter.gasModel4 "Gas medium in the dryer" annotation(Dialog(group="Fundamental Definitions"));
  parameter TILMedia.VLEFluidTypes.TILMedia_SplineWater medium_water=simCenter.fluid1 "Water medium in the dryer" annotation(Dialog(group="Fundamental Definitions"));
