...
public
  ...
  H2DryingSubsystem h2DryingSubsystem(water=water, medium_gas=medium_gas) annotation (Placement(transformation(extent={{-34,12},{-14,32}})));
equation
  connect(h2StorageSystem.H2PortOut, sink_syngas.gasPort) annotation (Line(
      points={{10,31.8},{36,31.8},{36,20},{42,20}},
      color={255,255,0},
      thickness=1.5));
  ...
  connect(h2DryingSubsystem.gasPortOut, h2StorageSystem.H2PortIn) annotation (Line(
      points={{-14,22},{-14,11.9},{10.1,11.9}},
      color={255,255,0},
      thickness=1.5));
