within H2Microgrid_TransiEnt.ElectrolyzerBoPSystem.OLD.FluidPortCooling;
model TestCooling_BuildingPump
  ...
  Cooling_BuildingPump cooling_BuildingPump annotation (Placement(transformation(extent={{-50,-12},{-30,8}})));
