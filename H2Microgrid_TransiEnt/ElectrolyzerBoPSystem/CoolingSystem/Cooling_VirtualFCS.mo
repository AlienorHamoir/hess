...
model Cooling_VirtualFCS
  ...
  VirtualFCS.Thermal.HeatSink heatSink(redeclare package Medium = medium_coolant) annotation (
    Placement(visible = true, transformation(origin={31,-57},     extent={{-7,-7},{7,7}},          rotation=270)));
  ...
  Modelica.Fluid.Pipes.DynamicPipe pipeCoolant(
    ...
    Placement(visible = true, transformation(origin={27,-37},   extent={{-5,5},{5,-5}},          rotation=-90)));
  ...
  Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation (
    Placement(visible = true, transformation(origin={50,-20},   extent = {{10, -10}, {-10, 10}}, rotation = 0), iconTransformation(origin = {50, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation (
    Placement(visible = true, transformation(origin={50,0},     extent = {{10, -10}, {-10, 10}}, rotation = 0), iconTransformation(origin = {-50, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput sensors[2] annotation (
    Placement(visible = true, transformation(origin={106,46},   extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-110, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
...
equation
  connect(heatSink.port_b,teeJunctionCoolantTank. port_1) annotation (
    Line(points={{26.1,-64},{26.1,-68},{-22,-68},{-22,-30}},
  ...
  connect(pin_n,pumpElectricDC. pin_n) annotation (
    Line(points={{50,0},{30,0},{30,-7},{34,-7}},            color = {0, 0, 255}));
  connect(pin_p,pumpElectricDC. pin_p) annotation (
    Line(points={{50,-20},{30,-20},{30,-13},{34,-13}},      color = {0, 0, 255}));
  ...
  connect(thermalConductor.port_b,pipeCoolant. heatPorts[1]) annotation (
    Line(points={{-42,-40},{-38,-40},{-38,-44},{6,-44},{6,-37.05},{24.8,-37.05}},
                                                            color = {191, 0, 0}));
  connect(thermalConductor.port_a,heatCapacitor1. port) annotation (Line(points={{-58,-40},{-74,-40}},
                                                                                                   color={191,0,0}));
  connect(pumpElectricDC.Output,pipeCoolant. port_a) annotation (Line(points={{26,-19},{27,-19},{27,-32}},
                                                                                                        color={0,127,255}));
  connect(heatSink.port_a,pipeCoolant. port_b) annotation (Line(points={{26.1,-50},{27,-50},{27,-42}},
                                                                                                    color={0,127,255}));
  ...
  connect(batterySystem.pin_n, pin_n) annotation (Line(points={{72.4,-20.4},{64,-20.4},{64,0},{50,0}}, color={0,0,255}));
  ...
  connect(pin_p, power_coolingPump.pv) annotation (Line(points={{50,-20},{50,-42},{80,-42}}, color={0,0,255}));
  connect(power_coolingPump.nv, power_coolingPump.nc) annotation (Line(points={{80,-62},{80,-66},{94,-66},{94,-52},{90,-52}}, color={0,0,255}));
  connect(pin_n, power_coolingPump.nv) annotation (Line(points={{50,0},{96,0},{96,-68},{80,-68},{80,-62}}, color={0,0,255}));
  connect(pin_p, batterySystem.pin_p) annotation (Line(points={{50,-20},{68,-20},{68,-11.6},{72.4,-11.6}}, color={0,0,255}));
