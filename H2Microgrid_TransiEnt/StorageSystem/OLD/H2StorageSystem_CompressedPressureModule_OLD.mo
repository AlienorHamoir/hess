...
model H2StorageSystem_CompressedPressureModule_OLD
protected
...
//       revenues=storage.summary.costs.revenues));
  ...
  OLD.H2Tank_Pressure h2Tank_Pressure(p_start=p_start) annotation (Placement(transformation(extent={{-26,58},{4,88}})));
...
end H2StorageSystem_CompressedPressureModule_OLD;
