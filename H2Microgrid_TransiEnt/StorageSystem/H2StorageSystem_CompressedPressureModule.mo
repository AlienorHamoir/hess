...
model H2StorageSystem_CompressedPressureModule
protected
...
//       revenues=storage.summary.costs.revenues));
  ...
  StorageSystem.H2Tank_Pressure h2Tank_Pressure(p_start=p_start) annotation (Placement(transformation(extent={{-26,58},{4,88}})));
...
equation
  ...
  connect(massFlowSensorToFC.gasPortOut, H2PortOut) annotation (Line(
      ...
      color={255,255,0},
      thickness=1.5));
  connect(massFlowSensorToFC.m_flow, h2Tank_Pressure.H2massFlowFC) annotation (Line(points={{79,-16},{82,-16},{82,0},{-32,0},{-32,67},{-23,67}}, color={0,0,127}));
  connect(h2Tank_Pressure.p_tank, tankSOC.currentTankPressure) annotation (Line(points={{0.85,72.85},{32,72.85},{32,85.8},{41.8,85.8}}, color={0,0,127}));
  connect(h2Tank_Pressure.p_tank, pressureTank) annotation (Line(points={{0.85,72.85},{90,72.85},{90,60},{106,60}}, color={0,0,127}));
  connect(controlCompressorAfterELY.p_afterCompIn, h2Tank_Pressure.p_tank) annotation (Line(points={{-4,30},{8,30},{8,72.85},{0.85,72.85}}, color={0,0,127}));
  ...
  connect(massFlowSensorFromElectrolyzer.gasPortOut, storage.gasPortIn) annotation (Line(
      ...
      color={255,255,0},
      thickness=1.5));
  connect(massFlowSensorFromElectrolyzer.m_flow, h2Tank_Pressure.H2massFlowElectrolyzer) annotation (Line(points={{-11,-16},{-8,-16},{-8,-2},{-34,-2},{-34,79},{-23,79}}, color={0,0,127}));
...
end H2StorageSystem_CompressedPressureModule;
