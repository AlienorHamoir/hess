within H2Microgrid_TransiEnt.FuelCellBoPSystem.FuelCell.Physics;
model Temperature_FC_ONGOING "PEMElectrolyzer thermal model as implemented by Espinosa, 2018 - modified equations for FC"
...
//________________________________________________________________________________//
  ...
  SI.TemperatureSlope der_T_op "Operating stack temperature derivative";
  ...
  SI.HeatFlowRate Q_flow_reac "W, power dissipated as heat from water electrolysis reaction";
  SI.HeatFlowRate Q_flow_gas "W; flow of Heat loss to ambient";
