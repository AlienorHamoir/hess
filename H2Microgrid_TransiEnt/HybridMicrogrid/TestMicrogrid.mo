...
model TestMicrogrid "Testing of hybrid microgrid"
  ...
  H2Microgrid_HP h2Microgrid_Compressed annotation (Placement(transformation(extent={{-22,-10},{34,38}})));
...
equation
  connect(BESScommand.y, h2Microgrid_Compressed.P_set_battery) annotation (Line(points={{-53,38},{-32,38},{-32,26.48},{-23.12,26.48}}, color={0,0,127}));
  connect(HESScommand.y, h2Microgrid_Compressed.P_set_HESS) annotation (Line(points={{-59,-8},{-32,-8},{-32,4.4},{-23.68,4.4}}, color={0,0,127}));
  annotation (
