...
model TestMicrogrid "Testing of hybrid microgrid"
  ...
  Modelica.Blocks.Sources.Sine HESScommand(
    ...
    offset=200)  annotation (Placement(transformation(extent={{-80,10},{-60,30}})));
...
equation
  connect(HESScommand.y, Microgrid_HP.P_set_FC) annotation (Line(points={{-59,20},{-34,20},{-34,6.8},{-23.68,6.8}}, color={0,0,127}));
  connect(HESScommand1.y, Microgrid_HP.P_set_EL) annotation (Line(points={{-59,-12},{-34,-12},{-34,-2.8},{-23.68,-2.8}}, color={0,0,127}));
